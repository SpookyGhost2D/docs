...
[discrete]
=== 17 July 2026
* *[NEW]* Add support for loading projects/textures/scripts and saving projects on Emscripten
* *[FIX]* Fix a torn/garbled sprite mesh after switching between script animations with different grid sizes
* *[FIX]* Fix an ImGui fatal assert related to icons font merging

[discrete]
=== 15 January 2026
* *[NEW]* Use the new nCine project build scripts to distribute Linux and MinGW dependency libraries
* *[NEW]* Write a JSON manifest file for pushed artifacts
